	...
	<h1>科目管理页</h1></div>
		...
		<div>
			<form action="subject" method="post">
				...
				<div style="position:absolute; width:700px;height:100px;line-height:25px; margin-top:-90px;text-align:center;">
					科目名：<input type="text" style="width:120px;margin-top:30px;" name="name" />
