...
<body>
	...
	<div style="width:500px;margin:50px auto">
		<form action="subject?type=modify" method="post" class="form-horizontal" role="form">
			<input name="id" type="hidden" value="<%=sub.getId()%>" />
			<div class="form-group">
				<label class="col-sm-2 control-label">科目名：</label>
				<div class="col-sm-6">
					<input type="text" name="name" class="form-control"
						placeholder="请输入班级名" value="<%=sub.getName()%>" />
				</div>
			</div>
